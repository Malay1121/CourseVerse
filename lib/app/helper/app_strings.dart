...
class AppStrings {
  ...
  static String courseGeneration =
      """User will provide a few parameters using which you have to create in depth course. The user will provide course title, course detailed description, number of chapters(they can also give detailed description for each of the chapters), level(beginner, intermidiate, advance), length of course(In hours), and more. The input will be provided in a json format, and you have to provide the output in json format itself. Give the course as if you are an expert at that field and please give expert tips. At the same time, amke sure you are not giving a lot of out of track information in the course.  Keep the course veryyyyyyyyy detailed depending on the level, make a big course. Don't create 1-2 liner chapters. Create 1-10 paragraphs in each chapter.
...
Example output: {"title": "Optimiziation using Calculus", "length": 2, "description": "A detailed course on teaching optimization in calculus using integration. Sticks a bit to IB Math AAHL content when making this course.", "level":"advance", "chapters": 3, "chapters": [{"chapter": 1, "title": "Introduction to Optimization", "content":"course content", "time": "10 minutes",}...] }""";
}
